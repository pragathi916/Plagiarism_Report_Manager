...
if (isset($_SESSION['username']) && isset($_SESSION['usertype'])) {
    ...
    if ($_SESSION['username'] !== $_POST['username']) {
        ...
        echo "<script>alert('Another user is already logged in. Please log out first.'); window.location.href='admin_login.html';</script>";
        exit();
    }
    ...
    echo "<script>alert('You are already logged in. Login time updated.'); window.location.href='admin.html';</script>";
    exit();
}
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $usertype = 'admin'; // Hardcoding admin usertype for admin login
